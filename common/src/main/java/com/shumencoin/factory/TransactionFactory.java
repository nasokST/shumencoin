...
public class TransactionFactory {
    ...
    public Transaction createTransaction(String from, String to, Integer value, Integer fee, String dateCreated,
		String data, String senderPubKey, String transactionDataHash, String senderSignature,
		Integer minedInBlockIndex, boolean transferSuccessful) {
	Transaction transaction = new Transaction(from, to, value, fee, dateCreated, data, senderPubKey, transactionDataHash, senderSignature, minedInBlockIndex, transferSuccessful);
...
//	    transaction.setTransactionDataHash(CryptoUtils.sha256(tranDataJSON)); // createclass with encryption
	}
	return transaction;
    }
